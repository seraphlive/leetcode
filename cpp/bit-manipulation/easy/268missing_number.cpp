...
// XOR all numbers and its index, which is
// (0,1,2,missing,...,n-1)^(0,1,2,...,n-1)
// == missing^n; XOR the result with n then missing one will be all that is
// left.
class Solution {
 public:
